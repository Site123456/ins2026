              ...
              <div className="overflow-y-auto flex-1 p-0 pb-8" style={{ scrollbarWidth: 'thin' }}>
                ...
                <div className="relative h-64 sm:h-80 overflow-hidden">
                  ...
                  <div className="absolute bottom-8 left-8 right-8">
                    <p className="text-xs font-black uppercase tracking-[0.3em] text-rose-500 mb-2 drop-shadow-md">{selectedDish.category}</p>
                    ...
                    <div className="flex items-center gap-4 flex-wrap">
                      <span className={`px-6 py-2.5 rounded-2xl font-black text-xl shadow-2xl ${isDark ? 'bg-white text-zinc-900' : 'bg-slate-900 text-white'}`}>
                ...
                <div className="px-8 pt-8 max-w-4xl mx-auto w-full">
                  ...
                  <div className={`border-t pt-10 ${isDark ? 'border-white/5' : 'border-slate-100'}`}>
                    <div className="flex items-center justify-between mb-8">
                      ...
                      {stats && stats.totalReviews > 0 && (
                        <span className={`text-xs px-4 py-1.5 rounded-full font-black ${isDark ? 'bg-white/5 text-zinc-400' : 'bg-slate-100 text-slate-500'}`}>
                    ...
                    <div className={`rounded-[2.5rem] p-8 mb-12 border transition-all ${isDark ? 'bg-white/[0.03] border-white/5' : 'bg-slate-50 border-slate-100'}`}>
                      ...
                      {!user ? (
                        <button onClick={() => openAuthModal('signin')}
                          ...
                          {isFr ? 'Connectez-vous pour voter ou commenter' : 'Sign in to vote or comment'}
                        </button>
                      ) : (
